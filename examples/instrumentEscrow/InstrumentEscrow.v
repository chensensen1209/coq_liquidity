  ...
  Proof.
    ...
    - pose proof Hready.
      ...
      assert (readyToStepState miner contract caddr s0 s').
      {
        ...
        unfold readyToStepState  in Hready.
        destruct_and_split.
        eapply transition_reachable_impl_reachable in H2.
        destruct H2 as [trace].
        eauto.
        eapply transition_next_state_queue_empty in Htrans.
        eauto.
        eauto.
        eauto.
      }
      ...
      destruct_and_split.
      pose proof H.
      eapply transition_reachable_impl_reachable in H5.
      ...
      eapply reachable_through_contract_deployed in H;eauto.
      unfold outgoing_acts.
      rewrite H1.
      intuition.
      eauto.
    ...
    - pose proof Hready.
      ...
      unfold funds.
      lia.
      eapply transition_reachable_impl_reachable_through in H7;eauto.
    ...
    - pose proof Hready.
      ...
      destruct_and_split.
      pose proof H.
      eapply transition_reachable_impl_reachable in H4.
      eapply balance_on_chain_forall in Hcs_s';eauto.
      exists s'.
      split.
      eauto.
  ...
  Proof.
    ...
    + assert(Htr1:exists s' : ChainState,
      ...
      assert(Hready' : readyToStepState miner contract caddr s0 s').
      {
        econstructor;eauto.
        econstructor;eauto.
        destruct Hrc_s' as [trace].
        pose proof Htranss' as Htt3.
        eapply transition_next_state_queue_empty in Htt3.
        eauto.
        eauto.
      }
      ...
      assert(funds s' caddr > 0).
      {
        ...
        eapply (reachable_funds_nonnegative s' caddr)  in H3.
        eauto.
        lia.
        eauto.
      }
      ...
      intros.
      eapply multiSuccTrace_delta_empty_refl_multr_s_tr in H4.
      destruct_and_split.
      inversion H5.
      eapply ULM_Step;eauto.
      eapply EPM_Base;eauto.
    ...
    + assert(Htt2:exists s' : ChainState,
      ...
      assert(Hready' : readyToStepState miner contract caddr s0 s').
      {
        econstructor;eauto.
        econstructor;eauto.
        eapply reachable_through_reachable in Hrct_s0_s'.
        destruct Hrct_s0_s' as [trace].
        pose proof Htranss' as Htt3.
        eapply transition_next_state_queue_empty in Htt3.
        eauto.
        eauto.
  ...
  Proof.
    ...
    + assert(Htr1:exists s' : ChainState,
      ...
      assert(Hbal: env_account_balances s''' caddr = balance cstate''').
      {
        eapply balance_on_chain_forall in H;eauto.
        eauto.
        eapply transition_reachable_impl_reachable_through in H4;eauto.
        eapply reachable_through_contract_deployed in H4;eauto.
        unfold outgoing_acts.
        rewrite H1.
        intuition.
      }
      ...
      assert(funds s' caddr > 0).
      {
        ...
        destruct_and_split.
        eapply transition_reachable_impl_reachable in H5.
        eapply (reachable_funds_nonnegative s' caddr)  in H5.
        eauto.
        lia.
        eauto.
      }
      ...
      eapply EPM_Step;eauto.
      intros.
      eapply multiSuccTrace_delta_empty_refl_multr_s_tr in H6.
      destruct_and_split.
      inversion H7.
      eapply ULM_Step;eauto.
      eapply EPM_Base;eauto.
      ...
      assert(funds s'' caddr > 0).
      {
        unfold readyToStepState  in Hready''.
        destruct_and_split.
        eapply transition_reachable_impl_reachable in H6.
        eapply (reachable_funds_nonnegative s'' caddr)  in H6.
        eauto.
        lia.
        eauto.
      }
      ...
      eapply EPM_Step;eauto.
      intros.
      eapply multiSuccTrace_delta_empty_refl_multr_s_tr in H9.
      destruct_and_split.
      inversion H12.
      eapply ULM_Step;eauto.
      eapply EPM_Base;eauto.
