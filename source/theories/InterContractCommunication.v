...
Section InterContractCommunication.
  ...
  Proof.
    ...
    - (* Contract deployment *)
      ...
      rewrite undeployed_contract_no_in_calls.
      eauto.
      rewrite e. auto.
  ...
  trace_induction; cbn in *;
    try destruct_address_eq; eauto; try easy.
    congruence.
    congruence.
  Qed.
  ...
  trace_induction;
    ...
    try eapply undeployed_contract_no_out_txs in not_deployed; auto;
    try unfold outgoing_txs in not_deployed;
    try now rewrite not_deployed.
    - cbn in *; destruct_address_eq.
    rewrite not_deployedB in deployed.
    inversion deployed.
    Unshelve.
    eauto.
    eauto.
  ...
  Proof.
    ...
    - rewrite undeployed_contract_no_in_calls by eauto. eauto.
...
Qed.
  ...
  Proof.
    ...
    - destruct_address_eq; auto; subst;
        try (apply some_inj in deployedA; subst);
        try (apply some_inj in deployedB; rewrite deployedB in *; clear deployedB);
