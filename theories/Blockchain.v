...
settable! build_env <env_chain; env_account_balances;env_contracts; env_contract_states>.
...
Record BlockHeader :=
  ...
  <chain_height; current_slot; finalized_height>.
...
Proof.
  ...
  specialize (address_eqb_spec (act_origin a) (act_from a)) as Haddr;
    unfold act_origin_is_eq_from in *; destruct Haddr; try easy; cbn.
    unfold act_origin_is_account .
    unfold act_is_from_account in H.
    rewrite e.
    eauto.
  Qed.
